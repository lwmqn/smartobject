...
[![Travis branch](https://img.shields.io/travis/lwmqn/smartobject/master.svg?maxAge=2592000)](https://travis-ci.org/lwmqn/smartobject)
[![npm](https://img.shields.io/npm/v/smartobject.svg?maxAge=2592000)](https://www.npmjs.com/package/smartobject)
[![npm](https://img.shields.io/npm/l/smartobject.svg?maxAge=2592000)](https://www.npmjs.com/package/smartobject) [![Greenkeeper badge](https://badges.greenkeeper.io/lwmqn/smartobject.svg)](https://greenkeeper.io/)
[![Coverage Status](https://coveralls.io/repos/github/lwmqn/smartobject/badge.svg?branch=master)](https://coveralls.io/github/lwmqn/smartobject?branch=master)
...
* The _**Resources**_ are used to describe what attributes may a gadget have, for example, a temperature sensor may have attributes such as _sensorValue_, _unit_, _minMeaValue_, .etc. _**Resource Values**_  will be filled after instantiated. Here is the [list of templates](https://github.com/lwmqn/smartobject/blob/master/docs/templates.md) to show you what attributes may a gadget have.  
...
* **Step 2**: Initialize a temperature sensor in your smart object `so`  (ref: [code templates](https://github.com/lwmqn/smartobject/blob/master/docs/templates.md))
    ```js
    so.init(
