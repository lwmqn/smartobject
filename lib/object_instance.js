...
function ObjectInstance(oidKey, iid) {
    ...
    Object.defineProperty(this, '_private', { value: {}, writable: true, enumerable: false, configurable: false });
}
...
ObjectInstance.prototype.init = function (resrcs, opt) {
    // each time of init(), all resources will be cleared. Use .set() to add/modify resource
    var self = this.clear(),
        ridKey;
